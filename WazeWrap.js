...
var WazeWrap = {Ready: false, Version: "2019.04.26.05"};
...
(function() {
    ...
    function injectCSS() {
		...
		'.WWAlertsHistory > .fa-exclamation-triangle {position: absolute; left:50%; margin-left:-12px; margin-top:8px;}',
