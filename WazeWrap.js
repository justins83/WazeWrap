...
var WazeWrap = {Ready: false, Version: "2019.04.26.08"};
...
(function() {
    ...
    function injectCSS() {
		...
		'.WWAlertsHistory-list{display:none; position:absolute; top:28px; border:2px solid black; border-radius:10px; background-color:white; padding:4px; overflow-y:auto; max-height: 200px;}',
